            ...
            [
                ...
                },
                {
                    ...
                    onPress: () => {
                        ...
                        return navigation.navigate("contratoContentFinalizarOff", { id: id, contratoID, unidadeID,
                             anexos: [
                                tratamentoImagem(anexo1, 'anexo1'),
                                tratamentoImagem(anexo2, 'anexo2'),
                                tratamentoImagem(anexo3, 'anexo3')
                            ],
                        });
                    }
                },
