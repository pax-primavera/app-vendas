...
function ContratoContentAnexosAdicional({ navigation }) {
    /// Config
                ...
                },
                {
                    ...
                    onPress: async () => {
                        ...
                        await executarSQL(`
                            ...
                            WHERE id = ${contratoID}
                        `);
                        return navigation.navigate("contratoContentFinalizarAdicional", {
                            id: id, contratoID, unidadeID, hum, anexos: [
                                anexo5,
                                anexo6,
                                anexo7,
                            ],
                ...
                <Box key="2" safeArea w="100%" pl="2" pr="2" mb="2" pb="2" maxW="100%" rounded="lg" overflow="hidden" borderColor="coolGray.200" borderWidth="1" _light={light} _web={web} >
                    ...
                    <VStack >
                        <VStack style={containerFoto}>
                            <VStack pl="5" pr="5">
                                <Text fontWeight="bold">Fotografe a frente do documento de identidade do dependente.</Text>
                            </VStack>
                            <Button size="lg"
                                m="5"
                        ...
                        <VStack style={containerFoto}>
                            <VStack pl="5" pr="5">
                                <Text fontWeight="bold">Fotografe o verso do documento de identidade do dependente.</Text>
                            </VStack>
                            <Button size="lg"
                                m="5"
                        ...
                        <VStack style={containerFoto}>
                            <VStack pl="5" pr="5">
                                <Text fontWeight="bold">Fotografe um documento adicional de comprovante.</Text>
                            </VStack>
                            <Button size="lg"
                                m="5"
...
export { ContratoContentAnexosAdicional }
