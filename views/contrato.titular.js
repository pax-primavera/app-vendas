...
import {
  ...
  validarCPF,
  validarEmail,
} from "../utils/generic/format";
import {
  fieldDatas,
  fieldCPF,
  fieldCEPS,
  fieldTelefones,
} from "../utils/generic/field.mask";
...
function ContratoContentTitular({ navigation }) {
  ...
  const setup = async () => {
    executarSQL(`select regiao from unidade where id = ${unidadeID}`).then((response) => {
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            let date1 = moment(today, "DD/MM/YYYY").format("YYYYMMDD");
            let date2 = moment(dataNascTitular, "DD/MM/YYYY").format(
              "YYYYMMDD"
            );
            const date3 = date1 - date2;
            if (date3 < 180000) {
              Alert.alert("Aviso.", "Menor de 18 anos!");
              return;
            }
            if (date3 >= 1200000) {
              Alert.alert("Aviso.", "Data de nascimento inválida!");
            ...
            if (!estadoCivilTitular) {
              Alert.alert("Aviso.", "Estado Civil é obrigatório!");
              return;
            }
            ...
            return navigation.navigate("contratoContentEnderecoResidencial", {
              contratoID,
              unidadeID,
            });
          },
              ...
              <Center w="100%" rounded="md">
                <FormControl isRequired>
                  ...
                  <Input
                    ...
                    onChangeText={(e) =>
                      setNomeTitular(
                        changeInput(e, "nomeTitular").toUpperCase()
                      )
                    }
              ...
              <Center w="50%" rounded="md">
                <FormControl isRequired>
                  ...
                  <Input
                    ...
                    value={cpfTitular}
                    onChangeText={(e) =>
                      setCpfTitular(changeInput(e, "cpfTitular"))
                    }
                    _focus={styleInputFocus}
                  />
                </FormControl>
              ...
              <Center w="50%" rounded="md">
                <FormControl isRequired>
                  ...
                  <Input
                    ...
                    value={rgTitular}
                    onChangeText={(e) =>
                      setRGTitular(changeInput(e, "rgTitular"))
                    }
                    _focus={styleInputFocus}
                  />
                </FormControl>
              ...
              <Center w="50%" rounded="md">
                <FormControl isRequired>
                  ...
                  <Input
                    ...
                    onChangeText={(e) =>
                      setDataNascTitular(changeInput(e, "dataNascTitular"))
                    }
                    _focus={styleInputFocus}
                  />
                </FormControl>
              ...
              <Center w="50%" rounded="md">
                <FormControl isRequired>
                  ...
                  <Input
                    ...
                    onChangeText={(e) =>
                      setNaturalidadeTitular(
                        changeInput(e, "naturalidadeTitular").toUpperCase()
                      )
                    }
                    _focus={styleInputFocus}
                  />
              ...
              <Center w="50%" rounded="md">
                <FormControl isRequired>
                  ...
                  <Input
                    ...
                    value={telefone1}
                    onChangeText={(e) =>
                      setTelefone1(changeInput(e, "telefone1"))
                    }
                    _focus={styleInputFocus}
                  />
                </FormControl>
              ...
              <Center w="50%" rounded="md">
                <FormControl isRequired>
                  ...
                  <Input
                    ...
                    value={telefone2}
                    onChangeText={(e) =>
                      setTelefone2(changeInput(e, "telefone2"))
                    }
                    _focus={styleInputFocus}
                  />
                </FormControl>
              ...
              <Center w="100%" rounded="md">
                <FormControl isRequired>
                  ...
                  <Input
                    ...
                    onChangeText={(e) =>
                      setProfissaoTitular(
                        changeInput(e, "profissaoTitular").toUpperCase()
                      )
                    }
                    _focus={styleInputFocus}
                  />
