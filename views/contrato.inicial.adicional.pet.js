...
function ContratoContentInicialAdicionalPET({ navigation }) {
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            if (id != null) {
              ...
              return navigation.navigate("contratoContentTitularAdicionalPET", { id, contratoID, unidadeID });
            } else {
...
export { ContratoContentInicialAdicionalPET };
