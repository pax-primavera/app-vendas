...
import { estados, logradouros } from '../utils/generic/data';
...
function ContratoContentEnderecoResidencialOff({ navigation }) {
    ...
    const setup = async () => {
        ...
        await executarListIDSQL(id).then((response) => {
            ...
            //ENDEREÇO COBRANÇA
            setTipoLogradouroCobranca(response._array[0].tipoLogradouroCobranca);
            ...
            setEstadoCobranca(response._array[0].estadoCobranca);
