...
function ContratoContentTitularAdicionalPET({ navigation }) {
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            return navigation.navigate("ContratoAdicionalPET", { id: id, contratoID, unidadeID });
          }
        },
      ],
      { cancelable: false }
...
export { ContratoContentTitularAdicionalPET };
