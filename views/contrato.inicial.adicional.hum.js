...
function ContratoContentInicialAdicionalHum({ navigation }) {
  const toast = useToast();
  const route = useRoute();
  /// IDS, integers
  const id = route.params.id;
  const hum = route.params.hum;
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            if (id != null) {
              ...
              return navigation.navigate("contratoContentTitularAdicional", { id, contratoID, unidadeID, hum });
            } else {
              setContratoID(novoContrato);
              return navigation.navigate("contratoContentTitularAdicional", { contratoID: novoContrato, unidadeID: unidadeID, hum });
            }
          }
        },
      ],
...
export { ContratoContentInicialAdicionalHum };
