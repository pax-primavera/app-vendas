...
function ContratoContentEnderecoVencimento({ navigation }) {
    /// Config
            ...
            [
                ...
                },
                {
                    ...
                    onPress: async () => {
                        ...
                        return navigation.navigate("contratoContentFinalizarVencimento", { id: id, contratoID, unidadeID });
                    }
                },
            ],
            { cancelable: false }
                                ...
                                <Center w="50%" rounded="md">
                                    <FormControl isRequired>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(e) => setEstadoResidencial(changeInput(e, 'estadoResidencial'))}
...
export { ContratoContentEnderecoVencimento }
